"""
MGA ADMET 추론 CLI entry point.

Usage:
    mga-infer --input "CC(=O)OC1=CC=CC=C1C(=O)O" --output result.json
    mga-infer --input data/compounds.csv --output results.csv
    mga-infer --input data.csv --mode batch --output out.csv --docker
"""
